...
class UpdateSettings extends Command
{
    ...
    public function handle()
    {
        $settings = [
            ...
            'meta_title_faqs' => 'Pusat Bantuan & FAQ | buyle.id',
            'meta_desc_faqs'  => 'Pusat Bantuan dan FAQ buyle.id. Temukan jawaban cepat untuk pertanyaan seputar transaksi, layanan, lisensi produk, dan panduan lainnya.',
            'meta_keywords_faqs' => 'pusat bantuan, faq buyle.id, pertanyaan umum, panduan pengguna, bantuan transaksi digital',
