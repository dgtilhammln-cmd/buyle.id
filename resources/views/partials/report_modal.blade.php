...
<style>
    ...
    .buyle-custom-select-trigger:hover,
    .buyle-custom-select-trigger.active {
        border-color: #1eb349;
        background: #ffffff;
    ...
    .buyle-report-input:focus,
    .buyle-report-textarea:focus {
        border-color: #1eb349;
        background: #ffffff;
        box-shadow: 0 0 0 3px rgba(30, 179, 73, 0.12);
    }
...
<div class="buyle-report-modal-overlay" id="buyleReportModal"
    onclick="if(event.target === this) closeBuyleReportModal()">
        ...
        <form id="buyleReportForm" onsubmit="submitBuyleReport(event)">
            ...
            <div class="buyle-report-form-group">
                ...
                <div class="buyle-custom-select-wrap">
                    <div class="buyle-custom-select-trigger" id="buyleSelectTrigger"
                        onclick="toggleBuyleCustomDropdown(event)">
                    ...
                    <div class="buyle-select-options" id="buyleSelectOptions">
                        <div class="buyle-option-item"
                            onclick="selectBuyleReportReason('penipuan', 'Penipuan / Toko Palsu')" data-key="penipuan">
                        ...
                        <div class="buyle-option-item"
                            onclick="selectBuyleReportReason('hak_cipta', 'Pelanggaran Hak Cipta / Brand')"
                            data-key="hak_cipta">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                        ...
                        <div class="buyle-option-item"
                            onclick="selectBuyleReportReason('konten_ilegal', 'Konten Ilegal / Melanggar Hukum')"
                            data-key="konten_ilegal">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                        ...
                        <div class="buyle-option-item"
                            onclick="selectBuyleReportReason('spam', 'Spam / Ujaran Kebencian / SARA')" data-key="spam">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                        ...
                        <div class="buyle-option-item" onclick="selectBuyleReportReason('lainnya', 'Alasan Lainnya')"
                            data-key="lainnya">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
            ...
            <div class="buyle-report-form-group">
                ...
                <textarea name="description" rows="3" class="buyle-report-textarea"
                    placeholder="Jelaskan detail laporan Anda secara singkat..."></textarea>
            </div>

            <div class="buyle-report-form-group">
                <label class="buyle-report-label">Email Anda (Opsional)</label>
                <input type="email" name="reporter_email" class="buyle-report-input"
                    placeholder="emailanda@gmail.com (untuk info tindak lanjut)">
            </div>
