...
@section('content')
    ...
    <style>
        ...
        .ticket-card-swipe-item, .article-card-swipe-item {
            flex: 0 0 260px;
            width: 260px;
        ...
        @media (max-width: 640px) {
            .responsive-section-title { font-size: 1.05rem !important; }
            .responsive-section-subtitle { font-size: 0.75rem !important; }
            .ticket-card-swipe-item, .article-card-swipe-item { flex: 0 0 240px; width: 240px; }
        }
    </style>
        ...
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 1.25rem;">
            ...
            <div style="display: flex; align-items: flex-end; justify-content: space-between; flex-wrap: wrap; gap: 0.75rem; margin-bottom: 1.25rem;">
                ...
                <a href="{{ route_locale('products') }}?category=tiket" style="display: inline-flex; align-items: center; gap: 0.35rem; font-size: 0.8rem; font-weight: 700; color: #1eb349; text-decoration: none; transition: all 0.2s;" onmouseover="this.style.transform='translateX(3px)'" onmouseout="this.style.transform='none'">
                    Lihat Semua Tiket
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M5 12h14m-7-7l7 7-7 7"/></svg>
                </a>
            </div>

            {{-- Ticket Category Pills (No Badges) --}}
            <div style="display: flex; gap: 0.5rem; overflow-x: auto; padding-bottom: 0.75rem; margin-bottom: 1.25rem; scrollbar-width: none;" class="no-scrollbar">
                <a href="{{ route_locale('products') }}?q=konser" style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;" onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'" onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M9 18V5l12-2v13E9 18zm0 0a3 3 0 11-6 0 3 3 0 016 0zm12 0a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    Tiket Konser & Musik
                </a>
                <a href="{{ route_locale('products') }}?q=workshop" style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;" onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'" onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                    Event & Workshop Edukasi
                </a>
                <a href="{{ route_locale('products') }}?q=wisata" style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;" onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'" onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                    Tiket Wisata & Rekreasi
                </a>
                <a href="{{ route_locale('products') }}?q=webinar" style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;" onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'" onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                    Webinar & Pass Online
                </a>
            </div>
            ...
            <div class="swipe-cards-container">
                ...
                @if($tProds->count() > 0)
                    @foreach($tProds as $tProd)
                        ...
                        @endphp
                        <a href="{{ route_locale('products.show', $tProd->slug) }}" style="text-decoration: none; color: inherit; display: block;" class="ticket-card-swipe-item">
                            <div style="background: #F0F7FF; border: 1.5px solid #E2E8F0; border-radius: 18px; padding: 0.75rem; transition: all 0.25s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02); height: 100%; display: flex; flex-direction: column;" class="ticket-card-box">
                                {{-- Image Banner --}}
                                ...
                                {{-- White Inner Box --}}
                                <div style="background: #ffffff; border-radius: 14px; padding: 0.9rem; margin-top: 0.75rem; box-shadow: 0 2px 8px rgba(0,0,0,0.02); flex: 1; display: flex; flex-direction: column; justify-content: space-between;">
                                    <div>
                                        <h3 style="font-family: 'Montserrat', sans-serif; font-size: 0.88rem; font-weight: 800; color: #0F172A; margin: 0 0 0.4rem; line-height: 1.35; height: 2.6em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">
                                            {{ $tProd->name }}
                                        </h3>
                                        <div style="display: flex; align-items: center; gap: 0.4rem; font-size: 0.75rem; font-weight: 600; color: #64748B; margin-bottom: 0.4rem;">
                                            <svg width="14" height="14" fill="none" stroke="#60A5FA" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                            {{ $tDate }}
                                        </div>
                                        <div style="font-family: 'Montserrat', sans-serif; font-size: 1rem; font-weight: 900; color: #0F172A;">
                                            @if($tPrice > 0)
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                                            ...
                                            <span style="font-size: 0.75rem; font-weight: 600; color: #475569; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                                {{ $tStoreName }}
                                            </span>
                                        </div>
                                    </div>
                ...
                @else
                    ...
                    @foreach($demoTickets as $dT)
                        <a href="{{ route_locale('products') }}?category=tiket" style="text-decoration: none; color: inherit; display: block;" class="ticket-card-swipe-item">
                            <div style="background: #F0F7FF; border: 1.5px solid #E2E8F0; border-radius: 18px; padding: 0.75rem; transition: all 0.25s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02); height: 100%; display: flex; flex-direction: column;" class="ticket-card-box">
                                <div style="position: relative; width: 100%; height: 130px; border-radius: 12px; overflow: hidden; background: #E2E8F0;">
            ...
            <div class="swipe-cards-container">
                ...
                @else
                    ...
                    @foreach($demoArticles as $dA)
                        <a href="{{ route_locale('articles') }}" style="text-decoration: none; color: inherit; display: flex; flex-direction: column;" class="article-card-swipe-item">
                            <div style="background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 16px; overflow: hidden; display: flex; flex-direction: column; height: 100%; transition: all 0.25s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);" class="article-card-box">
                                <div style="position: relative; width: 100%; height: 140px; background: #F1F5F9; overflow: hidden;">
