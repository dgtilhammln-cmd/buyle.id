...
@section('content')
    ...
    {{-- PRELOADER MOVED TO LAYOUTS/APP.BLADE.PHP --}}
    ...
    <style>
        ...
        .cv-cat-slide:hover .cv-cat-icon-wrap img {
            transform: scale(1.1);
        }
        ...
        .cv-cat-slide:hover .cv-cat-name {
            color: #1eb349;
        }
        ...
        .cv-cats-nav:hover {
            ...
            color: #fff;
            border-color: #1eb349;
            box-shadow: 0 6px 16px rgba(30, 179, 73, 0.25);
        }
        ...
        @media (max-width: 768px) {
            ...
            .cats-swiper-mobile-grid::-webkit-scrollbar {
                display: none;
            }
        }
    </style>
    ...
    <section class="cv-hero-modern" id="home" itemscope itemtype="https://schema.org/Organization">
        ...
        <meta itemprop="description"
            content="Toko online buyle.id tangga terlengkap di Surabaya. Temukan berbagai produk berkualitas dengan harga terbaik.">
        ...
        @if(!empty($settings['hero_bg_image']))
            <div class="cv-hero-bg-layer" style="background-image:url('{{ asset('storage/' . $settings['hero_bg_image']) }}')">
            </div>
        @endif
        ...
        <div class="cv-hero-grid">
            ...
            <div class="cv-hero-slider-col">
                        ...
                        <div class="swiper-wrapper">
                            @foreach($heroSlides as $slide)
                                <div class="swiper-slide hero-swiper-slide"
                                    data-bg-color="{{ $slide->bg_color ?? 'linear-gradient(180deg, #1e3a8a 0%, #3b82f6 100%)' }}">
                                    <a href="{{ $slide->button_url ?? '#' }}"
                                        style="display:block; width:100%; height:100%; text-decoration:none;"
                                        aria-label="{{ $slide->title }}">
                                        <img src="{{ asset('storage/' . $slide->image) }}" alt="{{ $slide->title }}"
                                            class="cv-hero-img-main" width="800" height="440" fetchpriority="high">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                ...
                @elseif(!empty($settings['hero_main_image']))
                    <img src="{{ asset('storage/' . $settings['hero_main_image']) }}" alt="Promo Utama" class="cv-hero-img-main"
                        width="800" height="440" fetchpriority="high">
                @else
                    <div
                        style="width:100%; height:100%; min-height:300px; border-radius:16px; background:#F1F5F9; display:flex; flex-direction:column; align-items:center; justify-content:center; color:#64748B; border:2px dashed #CBD5E1;">
                        ...
                        <span
                            style="font-family:'Montserrat',sans-serif; font-weight:600; font-size:1.1rem; color:#475569;">Banner
                            Utama Kosong</span>
            ...
            <div class="cv-hero-static-wrapper" style="display:flex; flex-direction:column; gap:0.75rem; height:440px;">
                ...
                @if(isset($utamaBanners) && $utamaBanners->count() > 0)
                    ...
                    <a href="{{ $utama->button_url ?? route('products') }}" class="cv-hero-static-col">
                        <img src="{{ asset('storage/' . $utama->image) }}" alt="{{ $utama->title }}" class="cv-hero-img-sec"
                            loading="lazy">
                    </a>
                @elseif(!empty($settings['hero_secondary_image']))
                    <a href="{{ route('products') }}" class="cv-hero-static-col">
                        <img src="{{ asset('storage/' . $settings['hero_secondary_image']) }}" alt="Promo"
                            class="cv-hero-img-sec" loading="eager">
                    </a>
                @else
                    <div
                        style="flex:1; min-height:0; border-radius:16px; background:#F1F5F9; display:flex; flex-direction:column; align-items:center; justify-content:center; color:#64748B; border:2px dashed #CBD5E1;">
                        ...
                        <span style="font-size:0.75rem; color:#94A3B8; text-align:center; padding:0 0.5rem;">Banner Utama
                            Kosong</span>
                    </div>
                @endif
                ...
                @if(isset($sampingBanners) && $sampingBanners->count() > 0)
                    ...
                    <a href="{{ $samping->button_url ?? route('products') }}" class="cv-hero-static-col">
                        <img src="{{ asset('storage/' . $samping->image) }}" alt="{{ $samping->title }}" class="cv-hero-img-sec"
                            loading="lazy">
                    </a>
                @elseif(!empty($settings['hero_third_image']))
                    <a href="{{ route('products') }}" class="cv-hero-static-col">
                        <img src="{{ asset('storage/' . $settings['hero_third_image']) }}" alt="Promo 2" class="cv-hero-img-sec"
                            loading="lazy">
                    </a>
                @else
                    <div
                        style="flex:1; min-height:0; border-radius:16px; background:#F8FAFC; display:flex; flex-direction:column; align-items:center; justify-content:center; color:#64748B; border:2px dashed #CBD5E1;">
                        ...
                        <span style="font-size:0.75rem; color:#94A3B8; text-align:center; padding:0 0.5rem;">Banner Samping
                            Kosong</span>
                    </div>
                @endif
            </div>
    ...
    <div style="display:none;" class="hide-on-mobile">
        <div style="max-width:1000px; margin:0 auto;">
            <h1
                style="font-size:1.4rem; font-weight:600; color:#1E293B; margin:0 0 0.25rem 0; font-family:'Montserrat', sans-serif;">
            ...
            <p style="font-size:0.9rem; color:#64748B; line-height:1.5; margin:0; font-family:'Montserrat', sans-serif;">
                Temukan ribuan karya dan produk digital berkualitas dari kreator lokal dengan harga terbaik dan akses
                instan.
            </p>
        </div>
    </div>
                    ...
                    <div class="cv-usp-item">
                        <span class="cv-usp-icon">
                            @if($usp->icon_type === 'upload' && $usp->icon_value)
                                <img src="{{ asset('storage/' . $usp->icon_value) }}" alt="{{ $usp->label }}" loading="lazy" width="24"
                    ...
                    <div class="swiper-wrapper">
                        @foreach($categoryItems as $cat)
                            <div class="swiper-slide">
                                <a href="{{ route('category.show', $cat->slug) }}" class="cv-cat-slide"
                                    aria-label="{{ $cat->name }}">
                                    <div class="cv-cat-icon-wrap">
                                        @if($cat->icon_type === 'upload' && $cat->icon_value)
                                            <img src="{{ asset('storage/' . $cat->icon_value) }}" alt="" loading="lazy"
                                                aria-hidden="true">
                                        @else
                                            @php
                                                $icons = [
                                            ...
                                            @endphp
                                            <svg width="28" height="28" fill="none" stroke="#1eb349" stroke-width="2.5"
                                                stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"
                                                aria-hidden="true">{!! $svg !!}</svg>
                                        @endif

                                        @if($cat->badge)
                                            <span class="cv-cat-badge"
                                                style="background:{{ $cat->badge_color ?? '#ef4444' }}">{{ $cat->badge }}</span>
                                        @endif
                                    </div>
    ...
    <style>
        ...
        .cv-promo-section[style*="linear-gradient"] {
            ...
            border-bottom: none;
            max-width: 1200px;
            /* SAME as regular sections — not full width */
            margin: 0 auto 1rem;
        ...
        .cv-promo-section[style*="linear-gradient"] .cv-promo-card-name {
            color: #1E293B;
        }
        ...
        .cv-promo-section.is-flash-section .cv-promo-title {
            color: #ffffff;
        }

        .cv-promo-section.is-flash-section .cv-promo-subtitle {
            color: rgba(255, 255, 255, 0.85);
        }

        .cv-promo-section.is-flash-section .cv-promo-view-all {
            color: #ffffff;
            opacity: 0.9;
        }

        .cv-promo-section.is-flash-section .cv-promo-view-all:hover {
            opacity: 1;
        }
        ...
        @media (max-width: 768px) {
            ...
            .cv-promo-banner-wrap.desktop-only {
                display: none;
            }
            ...
            .cv-promo-swiper .swiper-slide.cv-promo-banner-wrap {
                width: 155px !important;
            }
    ...
    <style>
        ...
        /* Responsive Section Titles & Horizontal Swipe Carousel */
        ...
        .swipe-cards-container::-webkit-scrollbar-thumb {
            background: #CBD5E1;
            border-radius: 99px;
        }

        .ticket-card-swipe-item,
    ...
    <section
        ...
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 1.25rem;">
            ...
            {{-- Ticket Category Pills (No Badges) --}}
            <div style="display: flex; gap: 0.5rem; overflow-x: auto; padding-bottom: 0.75rem; margin-bottom: 1.25rem; scrollbar-width: none;"
                class="no-scrollbar">
                <a href="{{ route_locale('products') }}?q=konser"
                    style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;"
                    onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'"
                    ...
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <path d="M9 18V5l12-2v13E9 18zm0 0a3 3 0 11-6 0 3 3 0 016 0zm12 0a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    Tiket Konser & Musik
                </a>
                <a href="{{ route_locale('products') }}?q=workshop"
                    style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;"
                    onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'"
                    onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <a href="{{ route_locale('products') }}?q=webinar"
                    style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.85rem; background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 99px; font-size: 0.76rem; font-weight: 700; color: #334155; text-decoration: none; white-space: nowrap; transition: all 0.2s;"
                    onmouseover="this.style.borderColor='#1eb349';this.style.color='#1eb349'"
                    onmouseout="this.style.borderColor='#E2E8F0';this.style.color='#334155'">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="swipe-cards-container">
                ...
                @if($tProds->count() > 0)
                    @foreach($tProds as $tProd)
                        @php
                            $tStoreName = $tProd->seller->creatorProfile->store_name ?? ($tProd->seller->name ?? ($tProd->seller_id ? 'Kreator #' . $tProd->seller_id : 'Kreator Terverifikasi'));
                            $tStoreAvatar = $tProd->seller->creatorProfile->avatar ?? ($tProd->seller->avatar ?? null);
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                                            <div
                                                style="width: 24px; height: 24px; border-radius: 50%; background: #F1F5F9; overflow: hidden; flex-shrink: 0; border: 1px solid #CBD5E1; display: flex; align-items: center; justify-content: center; font-size: 0.65rem; font-weight: 800; color: #1eb349;">
                                                @if($tStoreAvatar)
                                                    <img src="{{ asset('storage/' . $tStoreAvatar) }}"
                ...
                @if($arts->count() > 0)
                    @foreach($arts as $art)
                        ...
                        <a href="{{ route('articles.show', $art->slug) }}"
                            ...
                            <div style="background: #ffffff; border: 1.5px solid #E2E8F0; border-radius: 16px; overflow: hidden; display: flex; flex-direction: column; height: 100%; transition: all 0.25s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.02);"
                                class="article-card-box">
                                <div style="position: relative; width: 100%; height: 140px; background: #F1F5F9; overflow: hidden;">
                                    <img src="{{ $artImg }}" alt="{{ $artTitle }}"
                                        style="width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.3s ease;"
                                        class="article-banner-img">
                                </div>
                                <div
                                    style="padding: 1.1rem; display: flex; flex-direction: column; flex: 1; justify-content: space-between;">
                                    <div>
                                        <h3
                                            style="font-family: 'Montserrat', sans-serif; font-size: 0.92rem; font-weight: 800; color: #0F172A; margin: 0 0 0.5rem; line-height: 1.4; height: 2.6em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">
                                            {{ $artTitle }}
                                        </h3>
                                        <p
                                            style="font-size: 0.78rem; color: #64748B; margin: 0 0 1rem; line-height: 1.5; height: 3em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">
                                    ...
                                    <div
                                        ...
                                        <span
                                            style="font-size: 0.75rem; font-weight: 700; color: #1eb349; display: inline-flex; align-items: center; gap: 0.2rem;">
                                            Baca <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5"
                                                viewBox="0 0 24 24">
                                                <path d="M5 12h14m-7-7l7 7-7 7" />
                                            </svg>
                                        </span>
