...
.csi-inner { position: relative; z-index: 1; }
.csi-icon-wrap {
...
.csi-num.csi-flip { animation: csi-flip 0.22s ease; }
@keyframes csi-flip {
...
.csi-feat svg { color: #1eb349; flex-shrink: 0; }

@media (max-width: 480px) {
    .csi-unit { min-width: 58px; padding: 0.9rem 0.6rem 0.7rem; }
    .csi-sep { font-size: 1.4rem; }
    .csi-countdown { gap: 0.4rem; }
}
</style>
    ...
    <div class="csi-inner">
        ...
        <div class="csi-icon-wrap">
            <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
                ...
                <path d="M2 17l10 5 10-5" stroke="#1eb349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M2 12l10 5 10-5" stroke="#a5cf37" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
