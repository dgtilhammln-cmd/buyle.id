...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Header Banner with Buyle Brand Green */
        .header {
            background: #1eb349;
            padding: 22px 36px;
            display: table;
        ...
        .brand-name { font-size: 26px; font-weight: 900; color: #ffffff; letter-spacing: -0.5px; }
        .brand-dot { color: #a5cf37; }
        .brand-tagline { font-size: 10px; color: #e2f5e7; margin-top: 2px; letter-spacing: 0.5px; text-transform: uppercase; }
        .header-label { font-size: 10px; color: #d1fae5; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 700; }
        .header-title { font-size: 18px; font-weight: 800; color: #ffffff; margin-top: 2px; }
        ...
        .doc-info-label { font-size: 9px; text-transform: uppercase; letter-spacing: 0.8px; color: #64748B; font-weight: 700; margin-bottom: 3px; }
        .doc-info-value { font-size: 12px; font-weight: 700; color: #0F172A; }
        .doc-info-value-green { font-size: 12px; font-weight: 700; color: #166534; background: #DCFCE7; padding: 2px 8px; border-radius: 4px; display: inline-block; }
        ...
        .ticket-event-name { font-size: 14px; font-weight: 800; color: #ffffff; }
        .ticket-holder { font-size: 10px; color: #e2f5e7; margin-top: 2px; }
        .ticket-status-valid { font-size: 9px; font-weight: 800; padding: 4px 10px; border-radius: 99px; text-transform: uppercase; background: #ffffff; color: #166534; }
        .ticket-status-used { font-size: 9px; font-weight: 800; padding: 4px 10px; border-radius: 99px; text-transform: uppercase; background: #FEF3C7; color: #92400E; }
        .ticket-body { display: table; width: 100%; background: #ffffff; }
        .ticket-qr-col {
            display: table-cell;
        ...
        .ticket-qr-img { width: 110px; height: 110px; display: block; margin: 0 auto 6px; }
        .ticket-code { font-family: 'DejaVu Sans Mono', monospace; font-size: 9px; font-weight: 700; color: #334155; word-break: break-all; letter-spacing: 0.5px; }
        ...
        .info-label { font-size: 9px; text-transform: uppercase; letter-spacing: 0.7px; color: #64748B; font-weight: 700; margin-bottom: 2px; }
        .info-value { font-size: 12px; font-weight: 700; color: #0F172A; }
        
        .summary-section { padding: 10px 36px 20px; }
        .summary-table { width: 100%; border-collapse: collapse; }
        .summary-table td { padding: 8px 0; font-size: 12px; color: #475569; border-bottom: 1px solid #F1F5F9; }
        ...
        .footer-brand { font-size: 14px; font-weight: 900; color: #1eb349; }
        .footer-brand-dot { color: #a5cf37; }
        .footer-url { font-size: 10px; color: #64748B; font-weight: 600; }
        .footer-text { font-size: 10px; color: #64748B; }
        .watermark-notice { text-align: center; padding: 10px 36px 16px; font-size: 10px; color: #94A3B8; letter-spacing: 0.5px; }
    </style>
</head>
<body>
...
@php
    ...
    if ($logoSetting && file_exists($logoPath)) {
        ...
        if ($mime === 'image/webp' && function_exists('imagecreatefromwebp')) {
            ...
            if ($img) {
                ...
                imagedestroy($img);
                $logoBase64 = 'data:image/png;base64,' . base64_encode($pngData);
            }
        } else {
...
@endphp
    ...
    <div class="header">
        <div class="header-left">
            @if($logoBase64)
                <img src="{{ $logoBase64 }}" class="logo-img" alt="buyle.id">
            @else
    ...
    <div class="summary-section">
        <table class="summary-table">
            ...
            <tr>
                <td>Diskon</td>
                <td class="right" style="color:#166534;">-Rp {{ number_format($order->discount, 0, ',', '.') }}</td>
            </tr>
            @endif
            <tr class="total">
    ...
    <div class="footer">
        <div class="footer-left">
            @if($logoBase64)
                <img src="{{ $logoBase64 }}" style="height:26px;width:auto;" alt="buyle.id">
            @else
