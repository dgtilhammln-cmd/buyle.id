...
.ord-tab:hover { color:#1eb349; }
.ord-tab.ord-active { color:#1eb349; border-bottom-color:#1eb349; }
...
.order-card:hover { box-shadow:0 8px 24px rgba(30,179,73,0.08); border-color:#bbf7d0; }
...
.order-item-more { font-size:0.75rem; font-weight:600; color:#1eb349; background:#dcfce7; padding:0.2rem 0.6rem; border-radius:4px; display:inline-block; align-self:flex-start; }
