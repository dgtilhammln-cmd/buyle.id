        ...
        @if($wishlists->count())
            <div style="display:grid; grid-template-columns:repeat(auto-fill,minmax(200px,1fr)); gap:1rem;">
                ...
                <a href="{{ route('products.show', $wl->product->slug) }}"
                   ...
                   onmouseover="this.style.borderColor='#1eb349'; this.style.boxShadow='0 6px 20px rgba(30,179,73,0.1)'"
                   onmouseout="this.style.borderColor='#E2E8F0'; this.style.boxShadow='none'">
                    ...
                    <div style="padding:0.875rem;">
                        ...
                        @if($wl->product->price)
                        <div style="font-size:0.875rem; font-weight:800; color:#1eb349;">Rp {{ number_format($wl->product->price, 0, ',', '.') }}</div>
                        @endif
                    </div>
                </a>
                @endif
