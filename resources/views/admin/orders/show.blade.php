                    ...
                    <div class="od-card">
                        ...
                        <form action="{{ route('admin.orders.shipping_cost', $order) }}" method="POST">
                            ...
                            <div class="od-form-group">
                                ...
                                <input type="number" name="shipping_cost" class="od-input" placeholder="Contoh: 15000"
                ...
                <div class="od-card">
                    ...
                    <div class="od-info-list">
                        <div class="od-info-item">
                            ...
                            <span class="od-info-val">{{ $order->user->name ?? '-' }} <br><span
                                    style="font-size:.75rem;color:#64748B;">{{ $order->user->email ?? '-' }}</span></span>
                        </div>
                        <div class="od-info-item">
