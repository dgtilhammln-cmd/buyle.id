...
<div style="margin-bottom:1.5rem; display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem;">
  ...
  <form method="GET" action="{{ route('admin.dashboard') }}" style="display: flex; gap: 0.5rem; align-items: center;">
    ...
    <button type="submit" class="btn-primary" style="padding: 0.5rem 1.25rem; font-size: 0.8rem; border-radius: 50px; background: linear-gradient(135deg, #1eb349, #a5cf37); color: #fff; border: none; cursor: pointer; font-weight: 600;">Filter</button>
