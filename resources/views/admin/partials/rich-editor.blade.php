...
(function(){
  ...
  window['edImage'] = function(id) {
    ...
    input.onchange = function(e) {
        ...
        document.execCommand('insertHTML', false, `<span id="${loadingId}" style="color:var(--yellow);font-style:italic;">[Mengompresi & mengunggah gambar...]</span>`);
        ...
        compressImage(file).then(compressedFile => {
            ...
            .then(data => {
                ...
                if(data.url) {
                    const imgHtml = `<img src="${data.url}" style="max-width:100%; height:auto; border-radius:8px; margin:1rem 0; display:block;">`;
