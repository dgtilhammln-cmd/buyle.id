...
<div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem;">
  ...
  <div style="flex:1;">
    ...
    <p style="font-size:.8rem;color:#94A3B8;margin:0;">Perbarui informasi dan konten: <strong style="color:#1eb349;">{{ $s->name }}</strong></p>
  </div>
...
<div style="display:flex;flex-direction:column;gap:1.5rem;position:sticky;top:1.5rem;">
    ...
    <div style="display:flex;flex-direction:column;gap:1rem;">
      <label style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;padding:.875rem 1rem;background:#F8FAFC;border-radius:12px;border:1.5px solid #E4E7F0;">
        ...
        <div style="position:relative;">
          ...
          <div id="toggle-track" onclick="document.getElementById('is_active_toggle').click()" style="width:44px;height:24px;border-radius:100px;cursor:pointer;transition:background .2s;position:relative;background:{{ old('is_active',$s->is_active)?'#1eb349':'#E4E7F0' }};">
  ...
  <div style="background:#fff;border-radius:20px;padding:1.5rem;box-shadow:0 2px 20px rgba(0,0,0,0.04);">
    ...
    @if($s->brochure)
    <a href="{{ asset('storage/'.$s->brochure) }}" target="_blank" style="display:inline-flex;align-items:center;gap:.375rem;font-size:.78rem;font-weight:700;color:#1eb349;background:rgba(30,179,73,0.08);padding:.4rem .875rem;border-radius:8px;text-decoration:none;margin-bottom:.875rem;transition:background .2s;" onmouseover="this.style.background='rgba(30,179,73,0.15)'" onmouseout="this.style.background='rgba(30,179,73,0.08)'">
      <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
...
function updateToggle(chk) {
  document.getElementById('toggle-track').style.background = chk.checked ? '#1eb349' : '#E4E7F0';
