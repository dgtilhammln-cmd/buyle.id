...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem;">
  <div>
    ...
    <p style="font-size:.875rem;color:#94A3B8;margin:0;">Kelola semua kategori & sub-kategori produk/jasa digital buyle.id</p>
  </div>
...
function showTab(tab) {
    ...
    document.getElementById('tab-produk-btn').style.cssText = tab === 'produk'
        ? 'padding:.5rem 1.25rem;border-radius:99px;font-size:.875rem;font-weight:700;cursor:pointer;border:none;background:linear-gradient(135deg,#1eb349,#a5cf37);color:#fff;'
        : 'padding:.5rem 1.25rem;border-radius:99px;font-size:.875rem;font-weight:700;cursor:pointer;border:1.5px solid #E2E8F0;background:#fff;color:#64748B;';
    document.getElementById('tab-jasa-btn').style.cssText = tab === 'jasa'
        ? 'padding:.5rem 1.25rem;border-radius:99px;font-size:.875rem;font-weight:700;cursor:pointer;border:none;background:linear-gradient(135deg,#1eb349,#a5cf37);color:#fff;'
        : 'padding:.5rem 1.25rem;border-radius:99px;font-size:.875rem;font-weight:700;cursor:pointer;border:1.5px solid #E2E8F0;background:#fff;color:#64748B;';
}
</script>
