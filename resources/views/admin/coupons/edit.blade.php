...
<div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem;">
  ...
  <div>
    <h1 style="font-size:1.375rem;font-weight:800;color:#1E293B;margin:0 0 .1rem;letter-spacing:-.02em;">Edit Voucher: {{ $coupon->code }}</h1>
    <p style="font-size:.8rem;color:#94A3B8;margin:0;">Perbarui informasi, syarat, dan masa berlaku voucher.</p>
  </div>
</div>
    ...
    <div style="background:#fff;border-radius:20px;padding:1.75rem;box-shadow:0 2px 20px rgba(0,0,0,0.04);">
      ...
      <div style="margin-top:2rem;display:flex;align-items:center;gap:.75rem;padding:1.25rem;background:#F8FAFC;border-radius:12px;">
        <div style="position:relative;display:inline-block;width:44px;height:24px;">
          <input type="checkbox" name="is_active" id="isActive" value="1" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }} style="opacity:0;width:0;height:0;position:absolute;z-index:-1;">
