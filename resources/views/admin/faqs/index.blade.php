...
@section('content')
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-bottom:1.75rem;">
    <div
      ...
      <div
        style="width:44px;height:44px;background:rgba(30,179,73,0.1);border-radius:12px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
        ...
        @empty
          <tr>
            <td colspan="7" style="padding:5rem;text-align:center;">
              ...
              <a href="{{ route('admin.faqs.create') }}"
                style="display:inline-flex;align-items:center;gap:.5rem;margin-top:1.25rem;background:#1eb349;color:#fff;font-size:.85rem;font-weight:700;padding:.625rem 1.25rem;border-radius:10px;text-decoration:none;">
      ...
      <div
        ...
        <div style="padding:1.25rem;flex:1;display:flex;flex-direction:column;">
          ...
          <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:.75rem;">
            ...
            @endif
            <code
              style="font-size:.7rem;background:#F8FAFC;color:#1eb349;padding:.2rem .5rem;border-radius:6px;border:1px solid #E2E8F0;">/{{ $a->slug }}</code>
          </div>
          ...
          <div
            ...
            <a href="{{ route('faqs.show', $a->slug) }}" target="_blank"
              style="font-size:.75rem;font-weight:700;color:#1eb349;text-decoration:none;display:flex;align-items:center;gap:.25rem;">
