...
<div style="max-width:1080px; margin:0 auto;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;flex-wrap:wrap;gap:1rem;">
        <div>
            ...
            <p style="font-size:.875rem;color:#94A3B8;margin:0;">Kelola konten FAQ, media, tags, dan optimasi SEO.</p>
        </div>
        <div style="display:flex;align-items:center;gap:0.75rem;">
            <a href="{{ route('admin.faqs.index') }}" class="btn-outline-new">
    ...
    <div>
        ...
        <div id="tab-content" class="cms-tab-pane active">
            <div class="premium-card">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    ...
                    <div class="form-group">
                        <label class="form-label">Slug (URL) <span class="hint">Otomatis dari pertanyaan jika kosong.</span></label>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="category" value="{{ old('category',$a?->category) }}" class="form-input" placeholder="Umum, Pembayaran, Pengiriman">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <textarea name="translations[id][excerpt]" class="form-textarea" rows="2" maxlength="500"
                        ...
                        placeholder="Ringkasan singkat jawaban FAQ...">{{ old('translations.id.excerpt', $t?->excerpt) }}</textarea>
            ...
            <div class="premium-card" style="padding:1.25rem 1.5rem;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
                    <label class="form-label" style="margin:0;font-size:.9rem;">Jawaban Lengkap FAQ <span class="req">*</span></label>
                ...
                <div class="editor-wrapper">
                    ...
                    <div id="editor-id" class="editor-area" contenteditable="true" oninput="syncContent()" placeholder="Ketik jawaban FAQ dengan profesional di sini...">{!! old('translations.id.content', $t?->content) !!}</div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
                ...
                <div class="premium-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" value="{{ old('tags', $a && $a->tags ? implode(', ',$a->tags) : '') }}" class="form-input" placeholder="faq, bantuan, info, buyle">
                    </div>
                </div>
            </div>
        </div>

        {{-- TAB 4: SEO (CONTAINS SUB-FAQ SECTION NOW) --}}
        <div id="tab-seo" class="cms-tab-pane">
            <div class="premium-card">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="translations[id][meta_title]" value="{{ old('translations.id.meta_title', $t?->meta_title) }}" class="form-input" maxlength="65" oninput="document.getElementById('mt-cnt').textContent=this.value.length" placeholder="Otomatis dari pertanyaan jika dikosongkan">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="translations[id][meta_keywords]" value="{{ old('translations.id.meta_keywords', $t?->meta_keywords) }}" class="form-input" placeholder="buyle.id, faq, bantuan">
                    </div>
                </div>
                <div class="form-group">
            ...
            {{-- SUB-FAQ MOVED TO SEO TAB --}}
            <div class="premium-card">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
                    <h3 style="font-size:.85rem;font-weight:700;color:#1E293B;text-transform:uppercase;letter-spacing:.05em;margin:0;">Sub-Pertanyaan FAQ (Opsional Schema)</h3>
                ...
                <p style="font-size:.8rem;color:#64748B;margin-bottom:1rem;line-height:1.5;">Tambah daftar pertanyaan turunan jika ada detail tambahan untuk Schema FAQPage Google.</p>
                <div id="faq-list-id" style="display:flex;flex-direction:column;gap:1rem;">
                    ...
                    <div class="faq-item" style="background:#F8FAFC;border:1px solid #E2E8F0;padding:1.25rem;border-radius:12px;position:relative;">
                        ...
                        <input type="text" name="translations[id][faqs][{{ $fi }}][q]" class="form-input" value="{{ $faq['q'] ?? '' }}" placeholder="Sub Pertanyaan?" style="margin-bottom:.75rem;background:#fff;">
    ...
    input.onchange = function(e) {
        ...
        compressImage(file).then(compressedFile => {
            ...
            .then(data => {
                ...
                if (data.url) {
                    const imgHtml = `<img src="${data.url}" alt="Gambar FAQ" style="max-width:100%; height:auto; border-radius:8px; margin:1rem 0; display:block;">`;
                    if (loadingEl) {
...
function addFaq() {
    ...
    document.getElementById('faq-list-id').insertAdjacentHTML('beforeend', `
        <div class="faq-item" style="background:#F8FAFC;border:1px solid #E2E8F0;padding:1.25rem;border-radius:12px;position:relative;">
            ...
            <input type="text" name="translations[id][faqs][${idx}][q]" class="form-input" placeholder="Sub Pertanyaan?" style="margin-bottom:.75rem;background:#fff;">
...
document.getElementById('article-form').addEventListener('submit', function(e) {
    ...
    if (!content || content.length < 10) errors.push('Jawaban FAQ wajib diisi.');
