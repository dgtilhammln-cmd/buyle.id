...
<head><meta name=\referrer\ content=\no-referrer\>
    ...
    <style>
        :root { --accent: #fff; --glass: rgba(255,255,255,0.15); --glass-border: rgba(255,255,255,0.25); --side: 24px; }
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body { background: linear-gradient(135deg, #a5cf37, #1eb349); color: #fff; font-family: 'Montserrat', sans-serif; min-height: 100vh; background-attachment: fixed; }
        .container { max-width: 500px; margin: 0 auto; padding-bottom: 60px; }

        /* Cover & Avatar */
        .cover-area { height: 160px; background: rgba(0,0,0,0.1); background-size: cover; background-position: center; position: relative; }
        .profile-container { text-align: center; position: relative; margin-top: -50px; padding: 0 var(--side); }
        .avatar-wrap { width: 100px; height: 100px; border-radius: 50%; border: 4px solid rgba(255,255,255,0.8); background: #fff; overflow: hidden; display: inline-block; margin-bottom: 0.75rem; box-shadow: 0 8px 24px rgba(0,0,0,0.15); }
        .avatar-wrap img { width: 100%; height: 100%; object-fit: cover; }
        .profile-name { font-size: 1.35rem; font-weight: 900; color: #fff; letter-spacing: -0.02em; text-shadow: 0 2px 8px rgba(0,0,0,0.2); }
        .profile-bio { font-size: 0.82rem; color: rgba(255,255,255,0.9); margin: 0.4rem 0; line-height: 1.5; max-width: 340px; margin: 0.4rem auto; text-shadow: 0 1px 4px rgba(0,0,0,0.2); }
        .badges { display: flex; gap: 0.5rem; justify-content: center; flex-wrap: wrap; margin-top: 0.6rem; }
        .badge { background: var(--glass); border: 1px solid var(--glass-border); border-radius: 999px; padding: 0.25rem 0.75rem; font-size: 0.72rem; color: rgba(255,255,255,0.7); display: flex; align-items: center; gap: 0.3rem; }

        /* Social Icons Row */
        .social-row { display: flex; justify-content: center; gap: 0.75rem; padding: 1.25rem var(--side) 0; }
        .social-icon { width: 44px; height: 44px; border-radius: 50%; background: var(--glass); border: 1px solid var(--glass-border); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.8); text-decoration: none; font-size: 1.1rem; transition: all 0.2s; }
        .social-icon:hover { background: var(--accent); color: #000; }
        ...
        .glass-btn { display: flex; align-items: center; gap: 0.85rem; background: var(--glass); border: 1px solid var(--glass-border); border-radius: 20px; padding: 14px 16px; text-decoration: none; color: #fff; transition: all 0.2s; margin-bottom: 10px; backdrop-filter: blur(12px); box-shadow: 0 4px 16px rgba(0,0,0,0.1); }
        .glass-btn:hover { background: rgba(255,255,255,0.25); transform: scale(1.02); }
        .glass-btn .btn-icon { width: 42px; height: 42px; border-radius: 12px; background: rgba(255,255,255,0.2); display: flex; align-items: center; justify-content: center; flex-shrink: 0; overflow: hidden; }
        .glass-btn .btn-icon img { width: 100%; height: 100%; object-fit: cover; }
        .glass-btn .btn-body { flex: 1; min-width: 0; }
        .glass-btn .btn-title { font-size: 0.88rem; font-weight: 800; color: #fff; }
        .glass-btn .btn-sub { font-size: 0.7rem; color: rgba(255,255,255,0.8); margin-top: 2px; }
        .glass-btn .btn-arrow { color: rgba(255,255,255,0.6); flex-shrink: 0; }
        ...
        .prod-card { background: var(--glass); border: 1px solid var(--glass-border); border-radius: 16px; overflow: hidden; text-decoration: none; color: #fff; display: flex; flex-direction: column; transition: all 0.2s; backdrop-filter: blur(12px); box-shadow: 0 4px 16px rgba(0,0,0,0.1); }
        .prod-card:hover { background: rgba(255,255,255,0.25); transform: translateY(-3px); }
        .prod-img-wrap { width: 100%; padding-top: 100%; position: relative; background: rgba(0,0,0,0.1); }
        ...
        .video-card { width: 130px; height: 200px; border-radius: 14px; overflow: hidden; flex-shrink: 0; position: relative; scroll-snap-align: start; background: #111; border: 1px solid var(--glass-border); }
        .video-card img { width: 100%; height: 100%; object-fit: cover; }
        .video-card::after { content: ''; position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 60%); }
        .video-card .tt-icon { position: absolute; top: 10px; left: 10px; z-index: 2; }
        .video-card .watch-label { position: absolute; bottom: 10px; left: 10px; font-size: 9px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; z-index: 2; }

        /* Footer */
        .footer-bio { text-align: center; margin-top: 3rem; padding-bottom: 2rem; }
        .footer-bio a { color: rgba(255,255,255,0.3); text-decoration: none; font-size: 10px; font-weight: 700; letter-spacing: 1px; }
        .footer-bio a:hover { color: var(--accent); }
