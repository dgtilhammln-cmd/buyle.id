...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Affiliate card */
        .aff-card-pub { display: flex; align-items: center; gap: 0.85rem; background: var(--glass); border: 1px solid var(--glass-border); border-radius: 20px; padding: 12px; text-decoration: none; color: #fff; transition: all 0.2s; margin-bottom: 10px; backdrop-filter: blur(12px); box-shadow: 0 4px 16px rgba(0,0,0,0.1); }
        .aff-card-pub:hover { background: rgba(255,255,255,0.25); transform: scale(1.02); }
