    ...
    <div class="container">
        ...
        <div class="cat-tabs-wrap fade-up" style="animation-delay:0.38s">
            <div class="cat-tabs" id="catTabs3">
                <div class="cat-tab active" data-tab="all" onclick="switchTab3('all',this)">Semua <span style="opacity:.6;font-size:.72rem;">{{ $totalAll }}</span></div>
                @if($hasAff)<div class="cat-tab" data-tab="rek" onclick="switchTab3('rek',this)">Rekomendasi <span style="opacity:.6;font-size:.72rem;">{{ $affBlocks->count() }}</span></div>@endif
        ...
        function switchTab3(tab, el) {
            document.querySelectorAll('#catTabs3 .cat-tab').forEach(t => t.classList.remove('active'));
            el.classList.add('active');
            document.querySelectorAll('[id^="tab3-"]').forEach(p => p.classList.remove('active'));
