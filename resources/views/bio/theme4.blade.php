...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .prod-card { background: #fff; border: 1px solid var(--glass-border); border-radius: 14px; overflow: hidden; text-decoration: none; color: var(--text); display: flex; flex-direction: column; transition: all 0.2s; box-shadow: 0 4px 6px rgba(0,0,0,0.02); }
        .prod-card:hover { border-color: #cbd5e1; transform: translateY(-2px); box-shadow: 0 10px 15px rgba(0,0,0,0.05); }
        .prod-img-wrap { width: 100%; padding-top: 100%; position: relative; background: #f1f5f9; border-bottom: 1px solid var(--glass-border); }
