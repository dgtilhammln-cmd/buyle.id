...
<head>
    ...
    {{-- Google Fonts: Montserrat (Full weights 300, 400, 500, 600, 700, 800, 900) --}}
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        body.t5-body {
            font-family: 'Montserrat', 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
