            ...
            <div class="t5-footer-location">
                ...
                @elseif(!empty($locationText))
                    <a href="https://maps.google.com/?q={{ urlencode($locationText) }}" target="_blank" rel="noopener"
                        class="t5-footer-map-link"
                        style="display:inline-flex; align-items:center; gap:0.4rem; font-size:0.78rem; color:#1eb349; text-decoration:none; margin-top:0.3rem;">
