    ...
    <div class="bio-layout">
        ...
        <div class="bio-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('creator.bio.save-theme') }}" method="POST">
                            ...
                            <div class="theme-grid">
                                @foreach(['theme1' => 'Gelap Elegan', 'theme2' => 'Minimalis Pro', 'theme3' => 'Gradient Neon', 'theme4' => 'Clean Light', 'theme5' => 'Web Profesional'] as $key => $label)
            ...
            <div class="tab-pane" id="tab-profile">
                        ...
                        <div class="hpsub-pane" id="hpsub-about">
                            ...
                            <div class="prof-card">
                                ...
                                <div class="card-body" style="display:grid; grid-template-columns:1fr 1fr; gap:1.25rem;">
                                    ...
                                    <div class="form-group"
                                        style="grid-column:1/-1; background:#f8fafc; padding:1rem; border-radius:12px; border:1px solid #e2e8f0;">
                                        <label class="form-label" style="font-weight:700; color:#0f172a;">Logo / Ikon Pojok
                                            Kiri Atas Card 1</label>
                                        @if(!empty($cfg['about_card1_logo_image']))
                                            <div style="margin-bottom:0.5rem; display:flex; align-items:center; gap:1rem;">
                                                ...
                                                <label
                                                    style="font-size:0.75rem; color:#ef4444; display:flex; align-items:center; gap:0.25rem; cursor:pointer;">
                                                    <input type="checkbox" name="delete_about_card1_logo" value="1"> Hapus Logo
                                                    Ini (Gunakan Ikon Default)
                                                </label>
                                            </div>
                                        @endif
                                        <input type="file" name="about_card1_logo_image" accept="image/*" class="form-input"
                                            style="height:auto; padding:0.4rem;">
                                        <small
                                            style="color:#94a3b8; font-size:0.72rem; display:block; margin-top:0.3rem;">Kosongkan
                                            jika ingin menggunakan ikon bawaan (default 4-dots lime green).</small>
                                    </div>

                                    {{-- Gradasi Warna & Background Image Card 1 --}}
                                    <div class="form-group"
                                        style="grid-column:1/-1; background:#f8fafc; padding:1rem; border-radius:12px; border:1px solid #e2e8f0; display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                                        <div style="grid-column:1/-1; font-weight:700; color:#0f172a; font-size:0.85rem;">
                                            Tampilan Gradasi &amp; Background Card 1</div>
                                        <div class="form-group">
                                            <label class="form-label">Warna Gradasi Awal (Start)</label>
                                            <input type="color" name="about_card1_bg_color1"
                                                value="{{ old('about_card1_bg_color1', $cfg['about_card1_bg_color1'] ?? '#09090b') }}"
                                                class="form-input" style="height:40px; padding:0.2rem; cursor:pointer;">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Warna Gradasi Akhir (End)</label>
                                            <input type="color" name="about_card1_bg_color2"
                                                value="{{ old('about_card1_bg_color2', $cfg['about_card1_bg_color2'] ?? '#312e81') }}"
                                                class="form-input" style="height:40px; padding:0.2rem; cursor:pointer;">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @if(!empty($cfg['about_card1_bg_image']))
                                                <div
                                                    ...
                                                    <img src="{{ asset('storage/' . $cfg['about_card1_bg_image']) }}"
                                                        style="width:80px; height:45px; object-fit:cover; border-radius:6px;">
                                                    <label style="font-size:0.72rem; color:#ef4444; cursor:pointer;">
                                                        <input type="checkbox" name="delete_about_card1_bg_image" value="1">
                                                        Hapus BG
                                                    </label>
                                                </div>
                                            @endif
                                            <input type="file" name="about_card1_bg_image" accept="image/*"
                                                class="form-input" style="height:auto; padding:0.4rem;">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Transparansi Image Overlay (0 - 100%)</label>
                                            <input type="number" name="about_card1_bg_opacity" min="0" max="100"
                                                value="{{ old('about_card1_bg_opacity', $cfg['about_card1_bg_opacity'] ?? 30) }}"
                                                class="form-input" placeholder="30">
                                            <small style="color:#94a3b8; font-size:0.7rem;">Default: 30% (semakin kecil
                                                semakin samar).</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"
                                        style="grid-column:1/-1; background:#f0fdf4; padding:1rem; border-radius:12px; border:1px solid #bbf7d0;">
                                        <label class="form-label"
                                            style="font-weight:700; color:#166534; margin-bottom:0.75rem;">Poin Keunggulan
                                            (Maksimal 5 Poin)</label>
                                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.85rem;">
                                            <div>
                                                <label style="font-size:0.75rem; font-weight:600; color:#15803d;">Keunggulan
                                                    1</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!empty($cfg['about_card2_image']))
                                            <div style="margin-bottom:0.75rem; display:flex; align-items:center; gap:1rem;">
                                                ...
                                                <label
                                                    style="font-size:0.75rem; color:#ef4444; display:flex; align-items:center; gap:0.25rem; cursor:pointer;">
                                                    <input type="checkbox" name="delete_about_card2_image" value="1"> Hapus Foto
                                                    Ini
                                                </label>
                                            </div>
                                        @endif
                ...
                {{-- SUBTAB 3: HALAMAN PRODUK (TEMA 5) --}}
                <div class="prof-subtab-pane" id="subtab-products-main" style="display:none;">
                    <form action="{{ route('creator.bio.save-profile') }}" method="POST">
                        ...
                        <div class="prof-card" style="border: 1.5px solid #1eb349; background: #fafdfb;">
                            <div class="prof-card-head" style="background:linear-gradient(135deg, #1eb349 0%, #15803d 100%); color:#ffffff; padding:0.85rem 1.25rem; font-weight:700; font-size:0.95rem; display:flex; justify-content:space-between; align-items:center;">
                                <span>Pengaturan SEO Meta Tags (Halaman Katalog Produk / Layanan)</span>
                                <span style="background:rgba(255,255,255,0.25); color:#ffffff; font-size:0.7rem; font-weight:700; padding:0.2rem 0.6rem; border-radius:20px; text-transform:uppercase;">Khusus Tema 5</span>
                            </div>
                            <div class="card-body" style="padding:1.25rem;">
                        ...
                        <div style="display:flex; justify-content:flex-end; margin-top: 1.5rem; padding-top:1rem; border-top:1.5px solid #e2e8f0;">
                            <button type="submit" class="btn-submit-sm" style="padding:0.75rem 2.2rem; font-size:0.9rem; font-weight:700;">Simpan Pengaturan Produk</button>
                        </div>
                    </form>
                </div>

                {{-- SUBTAB 4: HALAMAN KONTAK (TEMA 5) --}}
                <div class="prof-subtab-pane" id="subtab-contact-main" style="display:none;">
                    <form action="{{ route('creator.bio.save-profile') }}" method="POST">
                        ...
                        <div style="display:flex; justify-content:flex-end; margin-top: 1.5rem; padding-top:1rem; border-top:1.5px solid #e2e8f0;">
                            <button type="submit" class="btn-submit-sm" style="padding:0.75rem 2.2rem; font-size:0.9rem; font-weight:700;">Simpan Pengaturan Kontak</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        if (savedProfileSubtab) {
            ...
            var btnMap = {
                ...
                'subtab-products-main': 'btn-subtab-products',
                'subtab-contact-main': 'btn-subtab-contact'
            };
        ...
        // ── Footer Customization JS ──
        function syncFooterColor(pickerId, textId, value) {
            let p = document.getElementById(pickerId);
            let t = document.getElementById(textId);
            if (p) p.value = value;
            if (t) t.value = value;
        }
        function syncFooterColorFromText(pickerId, textId, value) {
        ...
        function updateFooterPreview() {
            let c1 = document.getElementById('footer_color1_picker')?.value || '#09121a';
            let c2 = document.getElementById('footer_color2_picker')?.value || '#064e3b';
            let gradient = `linear-gradient(135deg, ${c1}, ${c2})`;

            let gradPrev = document.getElementById('footerGradientPreview');
            if (gradPrev) gradPrev.style.background = gradient;

            let livePrev = document.getElementById('footerLivePreview');
            if (livePrev) livePrev.style.background = gradient;

            let opacity = (document.getElementById('footer_opacity_slider')?.value || 30) / 100;
            let overlay = document.getElementById('footerImgOverlay');
            if (overlay) overlay.style.opacity = opacity;
        }
        function previewFooterBgImage(input) {
            if (input.files && input.files[0]) {
                let reader = new FileReader();
                reader.onload = function(e) {
                    let overlay = document.getElementById('footerImgOverlay');
                ...
                @forelse($whitelabelProducts as $wlProd)
                    ...
                    <div class="whitelabelModalItem modal-card-item"
                        ...
                        <div
                            ...
                            <div>
                                @php
                                    $wlBasePrice = $wlProd->sale_price ?: ($wlProd->whitelabel_price ?: $wlProd->price);
                                    $wlOrigPrice = ($wlProd->sale_price && $wlProd->price > $wlProd->sale_price) ? $wlProd->price : null;
                                @endphp
                                <div style="font-size:0.68rem; color:#64748B;">Harga Modal Reseller:</div>
                            ...
                            <div style="display:flex; flex-direction:column; gap:0.35rem; margin-top:0.35rem;">
                                ...
                                @else
                                    ...
                                    <button type="button"
                                        onclick="openAddWhitelabelMarkupModal('{{ $wlProd->id }}', '{{ addslashes($wlProd->name) }}', '{{ route('products.show', $wlProd->slug) }}', {{ $wlProd->sale_price ?: ($wlProd->whitelabel_price ?: $wlProd->price) }})"
                                        style="width:100%; background:#1eb349; color:#fff; font-size:0.72rem; padding:0.35rem 0.4rem; height:32px; border-radius:8px; font-weight: 500; cursor:pointer; border:none; display:flex; align-items:center; justify-content:center; gap:0.25rem;">
