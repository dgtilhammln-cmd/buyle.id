            ...
            <div class="prof-card">
                ...
                <div class="card-body">
                    <p style="font-size:0.82rem; color:#64748b; margin-bottom:1.5rem;">
                        Tambahkan Google Maps pada bagian bawah halaman bio Anda. Cocok untuk toko fisik, kantor, atau lokasi acara.
                    </p>
                    <form action="{{ route('creator.bio.save-profile') }}" method="POST">
                        @csrf
                        <input type="hidden" name="bio_name" value="{{ $cfg['name'] ?? '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="embed_location" class="form-input" style="height:100px; padding:0.75rem;" placeholder='<iframe src="https://www.google.com/maps/embed?pb=..." width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>'>{{ $cfg['embed_location'] ?? '' }}</textarea>
                            <div style="font-size:0.75rem; color:#64748b; margin-top:0.5rem; background:#f8fafc; padding:0.75rem; border-radius:8px; border:1px solid #e2e8f0;">
                                <strong style="color:#0b120c; display:block; margin-bottom:0.25rem;">Cara mendapatkan kode:</strong>
                                1. Buka <a href="https://maps.google.com" target="_blank" style="color:#0284c7;">Google Maps</a> dan cari lokasi Anda.<br>
