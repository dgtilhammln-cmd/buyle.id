                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_type" id="productTypeSelect" class="form-input" onchange="toggleProductTypeFields(this.value)" required>
                                    <option value="physical" {{ old('product_type') == 'physical' ? 'selected' : '' }}>Produk Fisik / Barang / UMKM</option>
                                    <option value="makanan" {{ old('product_type') == 'makanan' ? 'selected' : '' }}>Makanan / Minuman / Kuliner</option>
                                    <option value="service" {{ old('product_type') == 'service' ? 'selected' : '' }}>Jasa / Layanan / Service</option>
                                ...
                                <select name="product_category_id" id="catSelect" class="form-input" required onchange="loadSubCat(this.value)">
                                    ...
                                    <optgroup label="--- TIKET & EVENT ---">
                                        @foreach($categories->where('tab', 'event') as $cat)
                                            <option value="{{ $cat->id }}" data-tab="{{ $cat->tab }}" {{ old('product_category_id') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                        @endforeach
                                    </optgroup>
                             ...
                             <div class="form-group full" id="physicalFieldsWrap" style="display:none; background:#F8FAFC; border:1.5px solid #E2E8F0; border-radius:16px; padding:1.5rem; width:100%; box-sizing:border-box;">
                                 ...
                                 <div class="form-grid">
                                     <div class="form-group">
                                         ...
                                         <input type="text" name="sku" value="{{ old('sku') }}" class="form-input" placeholder="Misal: BRG-001-RED">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input type="number" name="weight" id="input_weight" value="{{ old('weight') }}" class="form-input" placeholder="Misal: 500" min="0">
                                         <span class="form-hint">Berat dalam hitungan gram (1 Kg = 1000 Gram).</span>
                                     </div>

                                     <div class="form-group">
                                         <label class="form-label">Panjang (P) (cm)</label>
                                         <input type="number" name="length" id="input_length" value="{{ old('length') }}" class="form-input" placeholder="Misal: 20" min="0" step="0.1" oninput="calculateProductVolume()">
                                     </div>

                                     <div class="form-group">
                                         <label class="form-label">Lebar (L) (cm)</label>
                                         <input type="number" name="width" id="input_width" value="{{ old('width') }}" class="form-input" placeholder="Misal: 15" min="0" step="0.1" oninput="calculateProductVolume()">
                                     </div>

                                     <div class="form-group">
                                         <label class="form-label">Tinggi (T) (cm)</label>
                                         <input type="number" name="height" id="input_height" value="{{ old('height') }}" class="form-input" placeholder="Misal: 10" min="0" step="0.1" oninput="calculateProductVolume()">
                                     </div>

                                     <div class="form-group">
                                         <label class="form-label">Volume (P x L x T) (cm³)</label>
                                         <input type="number" name="volume" id="input_volume" value="{{ old('volume') }}" class="form-input" placeholder="Otomatis dihitung" readonly style="background:#f1f5f9; color:#475569; font-weight:700;">
