...
<style>
    ...
    .img-preview { width:80px; height:80px; object-fit:cover; border-radius:10px; display:none; }
        ...
        <div class="form-body">
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-input" placeholder="Contoh: Template Canva Premium Social Media Pack" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" class="form-input" placeholder="50000" min="0" required>
                    @error('price')<span class="form-error">{{ $message }}</span>@enderror
                </div>

                <div class="form-group">
                    <label class="form-label">Harga Coret (Rp)</label>
                    <input type="number" name="sale_price" value="{{ old('sale_price') }}" class="form-input" placeholder="Opsional" min="0">
                    <span class="form-hint">Kosongkan jika tidak ada diskon</span>
                </div>

                <div class="form-group">
                    <label class="form-label">Stok / Kuota</label>
                    <input type="number" name="stock" value="{{ old('stock') }}" class="form-input" placeholder="Opsional" min="0">
                    <span class="form-hint">Kosongkan jika stok unlimited (digital)</span>
                </div>

                <div class="form-group full">
                    <label class="form-label">Deskripsi Singkat</label>
                    <textarea name="short_desc" class="form-input" rows="2" placeholder="Deskripsi singkat produk (maks 160 karakter)" maxlength="160">{{ old('short_desc') }}</textarea>
        ...
        <div class="form-body">
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="form-input" placeholder="Otomatis menggunakan nama produk jika kosong">
                    <span class="form-hint">Maksimal 70 karakter</span>
                    @error('meta_title')<span class="form-error">{{ $message }}</span>@enderror
                </div>
                <div class="form-group full">
                    <label class="form-label">Meta Description</label>
                    <textarea name="meta_desc" class="form-input" rows="2" placeholder="Otomatis menggunakan deskripsi singkat jika kosong">{{ old('meta_desc') }}</textarea>
                    <span class="form-hint">Maksimal 160 karakter</span>
                    @error('meta_desc')<span class="form-error">{{ $message }}</span>@enderror
                </div>
                <div class="form-group full">
                    <label class="form-label">Meta Keywords</label>
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" class="form-input" placeholder="e.g. preset lightroom, ebook bisnis">
