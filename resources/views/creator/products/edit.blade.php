                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_type" id="productTypeSelect" class="form-input"
                                        ...
                                        <option value="service" {{ old('product_type', $product->product_type) == 'service' ? 'selected' : '' }}>Jasa / Layanan / Service (Marketplace & Store)</option>
                                        ...
                                        <option value="physical" {{ old('product_type', $product->product_type) == 'physical' ? 'selected' : '' }}>Produk Fisik / Barang / UMKM (Khusus Bio Link / Storefront)</option>
                                        <option value="makanan" {{ old('product_type', $product->product_type) == 'makanan' ? 'selected' : '' }}>Makanan / Minuman / Kuliner (Khusus POS / Storefront)</option>
                                    </select>
