        ...
        <div class="form-body">
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <textarea name="description" class="form-input" rows="5" placeholder="Jelaskan produk secara detail — apa yang didapat pembeli, cara akses, dsb.">{{ old('description', $product->description) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="img-upload-area" onclick="document.getElementById('img-input').click()">
                    @if($product->image)
                        <img id="imgPreview" class="img-preview" src="{{ Storage::url($product->image) }}" alt="Preview" style="display:block; margin:0 auto;">
                        <div id="imgPlaceholder" style="display:none;"></div>
                    @else
                        <img id="imgPreview" class="img-preview" src="" alt="Preview" style="display:none; margin:0 auto;">
                        <div id="imgPlaceholder">
                            ...
                            <p style="font-size:0.7rem; color:#cbd5e1; margin-top:0.2rem;">Biarkan kosong jika tidak ingin mengubah</p>
                        </div>
                    @endif
                </div>
