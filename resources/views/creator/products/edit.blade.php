                    ...
                    <div class="form-body">
                        <div class="form-grid">
                            ...
                            <div class="form-group full" style="margin-bottom:0;">
                                ...
                                <textarea name="description" id="description" class="form-input" rows="6" placeholder="Tuliskan deskripsi lengkap produk..." required>{{ old('description', $product->description) }}</textarea>
                            </div>
                        </div>
