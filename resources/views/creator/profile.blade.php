...
<div class="form-card">
    <form action="{{ route('creator.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-section-title">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            Identitas Toko
        </div>
        <div class="form-body">
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <textarea name="store_description" class="form-input" rows="4" placeholder="Ceritakan tentang toko Anda, spesialisasi Anda, dll.">{{ old('store_description', $profile->store_description) }}</textarea>
        ...
        {{-- Alamat Toko --}}
        <div class="form-section-title">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
        ...
        <div class="form-body">
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <textarea name="address" class="form-input" rows="2" placeholder="Nama Jalan, Gedung, No. Rumah">{{ old('address', $profile->address) }}</textarea>
                </div>
        ...
        {{-- SEO Pengaturan --}}
        <div class="form-section-title">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            Metadata SEO
        </div>
        <div class="form-body">
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $profile->meta_title) }}" class="form-input" placeholder="Optimal 60 karakter">
                    <span class="form-hint">Kosongkan untuk menggunakan nama toko sebagai fallback.</span>
                </div>
                <div class="form-group full">
                    <label class="form-label">Meta Description</label>
                    <textarea name="meta_desc" class="form-input" rows="2" placeholder="Optimal 150-160 karakter untuk snippet Google">{{ old('meta_desc', $profile->meta_desc) }}</textarea>
                    <span class="form-hint">Kosongkan untuk menggunakan deskripsi toko sebagai fallback.</span>
                </div>
                <div class="form-group full">
                    <label class="form-label">Meta Keywords</label>
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $profile->meta_keywords) }}" class="form-input" placeholder="Misal: template canva, desain grafis, jasa cv">
