...
hit('destination/province', "$base/destination/province", $key);
hit('destination/city/11', "$base/destination/city/11", $key);
hit('calculate/domestic-cost', "$base/calculate/domestic-cost", $key, 'POST', ['origin'=>304, 'destination'=>305, 'weight'=>1000, 'courier'=>'jne']);
